import { REMAINDER_PRIORITY } from './constants.js';
...
export function parseNoteTemplates(note) {
  if (!note) return [];
  const out = [];
...
export function isBudgetTemplate(t) {
  return t && t.kind !== 'goal';
}

export function isRemainderTemplate(t) {
